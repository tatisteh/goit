import java.util.Objects;
    ...
    //Сделать класс, который бы представлял путь - отрезок, у которого есть стартовая и финальная точка.
...
class StarTrack{
    ...
    public boolean equals(Object o) {
        ...
        return start.getX() == starTrack.start.getX() && start.getY() == starTrack.start.getY() && start.getZ() == starTrack.start.getZ() && finish.getX() == starTrack.finish.getX() && finish.getY() == starTrack.finish.getY() && finish.getZ() == starTrack.finish.getZ();
    }
